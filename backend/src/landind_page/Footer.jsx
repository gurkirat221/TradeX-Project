...
function Footer() {
  return (
    ...
    <div className="container border-top mt05" >
      <div className="row mt-5">
        <div className="col">
          <img src="media/images/TradeXlogo.png" style={{ width: "90%" }}></img>
          <p>&copy; 2010 - 2025, TradeX Broking Ltd. All rights reserved.</p>
        </div>
        <div className="col">
          <p>Company</p>
          <a href="" className="mt-6">About</a>
          <br></br>
          <a href="">Philosophy</a>
          <br></br>
      ...
      <div className="mt-5  text-small text-muted" style={{fontSize:"12px"}}>
        <p>
          ...
          through TradeX Commodities Pvt. Ltd. MCX: 46025; NSE-50001 – SEBI
          Registration no.: INZ000038238 Registered Address: TradeX Broking
